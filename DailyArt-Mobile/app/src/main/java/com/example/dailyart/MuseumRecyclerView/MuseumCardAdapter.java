...
public class MuseumCardAdapter extends RecyclerView.Adapter<MuseumCardViewHolder> {
    ...
    public MuseumCardAdapter(OnItemListenerMuseum listener, List<Museum> museumList, Activity activity) {
    ...
    public MuseumCardViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.card_layout_museums, parent,false);
